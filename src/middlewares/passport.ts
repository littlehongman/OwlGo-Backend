...
import { BASE_URL, GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, COOKIE_KEY } from "../utils/secrets";
...
//       // res.cookie(COOKIE_KEY, sid, { maxAge: 3600 * 1000, httpOnly: true, secure: true, sameSite: 'none'});//, secure: true });
//   }
